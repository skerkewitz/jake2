 ...
 * @author cwei
 */
public final class DummyDriver implements SoundDriver {

	static {
		Sound.register(new DummyDriver());
	}
	...
	/* (non-Javadoc)
	 * @see jake2.sound.SoundDriver#Shutdown()
	 */
	...
	/* (non-Javadoc)
	 * @see jake2.sound.SoundDriver#Update(float[], float[], float[], float[])
	 */
    ...
    /* (non-Javadoc)
	 * @see jake2.sound.SoundDriver#StopAllSounds()
	 */
