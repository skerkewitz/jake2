...
public class GameItemList {
	...
	public static TGItem itemlist[] = {
	//leave index 0 alone
	new TGItem(null, null, null, null, null, null, null, 0, null,
	 ...
	 */
	new TGItem("item_armor_combat", GameItems.Pickup_Armor, null, null, null,
	 ...
	 */
	new TGItem("item_armor_jacket", GameItems.Pickup_Armor, null, null, null,
	 ...
	 */
	new TGItem("item_armor_shard", GameItems.Pickup_Armor, null, null, null,
	 ...
	 */
	new TGItem("item_power_screen", GameItems.Pickup_PowerArmor, GameItems.Use_PowerArmor,
	 ...
	 */
	new TGItem("item_power_shield", GameItems.Pickup_PowerArmor, GameItems.Use_PowerArmor,
	        GameItems.Drop_PowerArmor, null, "misc/ar3_pkup.wav",
	 ...
	 * never in the world
	 */
	new TGItem("weapon_blaster", null, PlayerWeapon.Use_Weapon, null,
	 ...
	 */
	new TGItem("weapon_shotgun", PlayerWeapon.Pickup_Weapon,
	 ...
	 */
	new TGItem("weapon_supershotgun", PlayerWeapon.Pickup_Weapon,
	        PlayerWeapon.Use_Weapon, PlayerWeapon.Drop_Weapon,
	 ...
	 */
	new TGItem("weapon_railgun", PlayerWeapon.Pickup_Weapon,
	        PlayerWeapon.Use_Weapon, PlayerWeapon.Drop_Weapon,
	 ...
	 */
	new TGItem("ammo_shells", GameItems.Pickup_Ammo, null, GameItems.Drop_Ammo, null,
	        "misc/am_pkup.wav",
	 ...
	 */
	new TGItem("ammo_bullets", GameItems.Pickup_Ammo, null, GameItems.Drop_Ammo, null,
	        "misc/am_pkup.wav",
	 ...
	 */
	new TGItem("ammo_cells", GameItems.Pickup_Ammo, null, GameItems.Drop_Ammo, null,
	        "misc/am_pkup.wav",
	 ...
	 */
	new TGItem("ammo_rockets", GameItems.Pickup_Ammo, null, GameItems.Drop_Ammo, null,
	        "misc/am_pkup.wav",
	 ...
	 */
	new TGItem("ammo_slugs", GameItems.Pickup_Ammo, null, GameItems.Drop_Ammo, null,
	        "misc/am_pkup.wav",
	 ...
	 */
	new TGItem("item_quad", GameItems.Pickup_Powerup, GameItems.Use_Quad,
	 ...
	 */
	new TGItem("item_invulnerability", GameItems.Pickup_Powerup,
	 ...
	 */
	new TGItem("item_silencer", GameItems.Pickup_Powerup, GameItems.Use_Silencer,
	        GameItems.Drop_General, null, "items/pkup.wav",
	 ...
	 */
	new TGItem("item_breather", GameItems.Pickup_Powerup, GameItems.Use_Breather,
	        GameItems.Drop_General, null, "items/pkup.wav",
	 ...
	 */
	new TGItem("item_enviro", GameItems.Pickup_Powerup, GameItems.Use_Envirosuit,
	        GameItems.Drop_General, null, "items/pkup.wav",
	 ...
	 */
	new TGItem("item_ancient_head", GameItems.Pickup_AncientHead, null, null,
	 ...
	 * +1 to maximum health
	 */
	new TGItem("item_adrenaline", GameItems.Pickup_Adrenaline, null, null, null,
	 ...
	 */
	new TGItem("item_bandolier", GameItems.Pickup_Bandolier, null, null, null,
	 ...
	 */
	new TGItem("item_pack", GameItems.Pickup_Pack, null, null, null,
	 ...
	 * computer centers
	 */
	new TGItem("key_data_cd", GameItems.Pickup_Key, null, GameItems.Drop_General,
	        null, "items/pkup.wav",
	 ...
	 */
	new TGItem("key_power_cube", GameItems.Pickup_Key, null,
	        GameItems.Drop_General, null, "items/pkup.wav",
	 ...
	 * entrance of jail3
	 */
	new TGItem("key_pyramid", GameItems.Pickup_Key, null, GameItems.Drop_General,
	        null, "items/pkup.wav",
	 ...
	 */
	new TGItem("key_data_spinner", GameItems.Pickup_Key, null,
	        GameItems.Drop_General, null, "items/pkup.wav",
	 ...
	 */
	new TGItem("key_pass", GameItems.Pickup_Key, null, GameItems.Drop_General,
	 ...
	 * door key - blue
	 */
	new TGItem("key_blue_key", GameItems.Pickup_Key, null,
	        GameItems.Drop_General, null, "items/pkup.wav",
	 ...
	 * key - red
	 */
	new TGItem("key_red_key", GameItems.Pickup_Key, null, GameItems.Drop_General,
	        null, "items/pkup.wav",
	...
	new TGItem("key_airstrike_target", GameItems.Pickup_Key, null,
	        ...
	        /* precache */
	        ""),
	new TGItem(null, GameItems.Pickup_Health, null, null, null,
