...
public class GameFunc {
    ...
    static void AngleMove_Calc(TEntityDict ent, EntThinkAdapter func) {
    ...
    static void plat_go_up(TEntityDict ent) {
    ...
    static void plat_spawn_inside_trigger(TEntityDict ent) {
        TEntityDict trigger;
    ...
    static void door_use_areaportals(TEntityDict self, boolean open) {
        TEntityDict t = null;
    ...
    static void door_go_up(TEntityDict self, TEntityDict activator) {
    ...
    static void train_resume(TEntityDict self) {
        TEntityDict ent;
        float[] dest = { 0, 0, 0 };
    ...
    static void SP_func_timer(TEntityDict self) {
        if (0 == self.wait)
            self.wait = 1.0f;
